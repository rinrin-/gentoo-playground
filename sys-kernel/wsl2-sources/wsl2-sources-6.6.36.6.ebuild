...
DESCRIPTION="Microsoft WSL2 Standard Linux 6.6.36.6"

SRC_URI="https://github.com/microsoft/WSL2-Linux-Kernel/archive/refs/tags/linux-msft-wsl-6.6.36.6.tar.gz -> ${P}.tar.gz"
